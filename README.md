...
- Reference script template: [v-update-web-domain-stat](test/awstats/conf/v-update-web-domain-stat)
- Reference config template: [awstats.tpl](test/awstats/conf/awstats.tpl)
